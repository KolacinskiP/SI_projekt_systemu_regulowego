  ...
  {  
   ...
   Netflix()
     {  
      try
        {
         netflixResources = ResourceBundle.getBundle("resources.NetflixResource",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(netflixResources.getString("Netflix"));  
      ...
      jfrm.getContentPane().add(runtimePanel); 
      jfrm.getContentPane().add(choicesPanel); 
      jfrm.getContentPane().add(buttonPanel); 

      /*========================*/
      /* Load the Netflix program. */
      /*========================*/
      
      clips = new Environment();
      
      clips.load("Netflix.clp");
   ...
   private void nextUIState() throws Exception
     {
      ...
      theText = netflixResources.getString(fv.getFactSlot("runtime").symbolValue());
